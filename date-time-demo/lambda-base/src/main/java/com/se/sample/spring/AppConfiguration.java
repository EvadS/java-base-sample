    ...
    public ServletContextInitializer initializer() {
        return new ServletContextInitializer() {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "com.se.sample");
                servletContext.setInitParameter("tapestry.development-modules", "com.se.sample.services.DevelopmentModule");
