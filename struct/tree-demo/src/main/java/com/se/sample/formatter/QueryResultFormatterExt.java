...
/**
 * базовый используемый вариант
 */

public class QueryResultFormatterExt {
    ...
    private static final Logger logger = LogManager.getLogger(QueryResultFormatterExt.class);


    public static void main(String[] args) throws IOException {
        List<Map<String, Object>> maps = FileUtils.readListMapFromDocumentSubFolder("base_records_for_sort.json");

        List<Map<String, Object>> childs = new QueryResultFormatterExt().getChilds(maps, "", 5);
